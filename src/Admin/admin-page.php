...
<div class="wpp-wrapper wpp-section-<?php echo $current; ?>">
    ...
    <div id="wpp-chart-wrapper">
        ...
        <ul class="wpp-header-nav" id="wpp-time-ranges">
            ...
            <li <?php echo ('last5days' == $this->config['stats']['range'] || 'last5days' == $this->config['stats']['range'] ) ? ' class="current"' : ''; ?>><a href="#" data-range="last5days" title="<?php esc_attr_e('Last 5 days', 'wordpress-popular-posts'); ?>">5d</a></li>
